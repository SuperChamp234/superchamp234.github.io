...
\resumeItemListStart
\resumeItem{Contributed to the \textbf{BeagleV-Fire gateware} with new functionality additions and improved documentation for multiple APB/AXI peripherals.}
\resumeItem{Implemented a custom \textbf{APB3 slave}, verified via userspace C application using memory-mapped I/O.}
\resumeItem{Configured MSS pins to enable \textbf{CAN \& RS485 cape} support through cape gateware modifications.}
\resumeItem{Debugged Microchip's DMA example with vendor support and helped fix a critical bug.}
\resumeItem{Built and CI-integrated a \textbf{RetroPie Debian image builder} for BeagleY-AI using debootstrap.}
\resumeItemListEnd
\resumeSubheading
